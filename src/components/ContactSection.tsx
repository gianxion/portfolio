      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 opacity-0 animate-fade-in animate-delay-2">
            <h3 className="text-2xl font-bold text-portfolio-dark mb-6">
              Let's start a conversation
            </h3>
            <p className="text-portfolio-dark/70 mb-8">
              Have a project in mind or just want to say hello? I'd love to hear
              from you. Fill out the form or reach out directly through one of
              the channels below.
            </p>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-portfolio-dark">+306949989387</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-portfolio-dark">Veria, Greece</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="glass-card rounded-xl p-8">
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  <label
                    htmlFor="name"
                    className="block text-sm font-medium text-portfolio-dark/70 mb-2"
                  >
                    Name
                  </label>
                  <input
