          ...
          <div>
            ...
            <div className="space-y-4 opacity-0 animate-fade-in animate-delay-2">
              <p className="text-portfolio-dark/80">
                ...
                detail and a commitment to creating intuitive, user-centered
                digital experiences. With a background spanning both design and
                development, I bring a holistic approach to every project.
              </p>
              <p className="text-portfolio-dark/80">
                My journey began in graphic design before expanding into
                frontend development, giving me unique insights into both the
                aesthetic and technical aspects of digital products. I believe
                in the power of thoughtful design to solve problems and in clean
                code to implement those solutions effectively.
              </p>
              <p className="text-portfolio-dark/80 mb-8">
                Whether crafting beautiful interfaces or building robust
                applications, my goal remains the same: to create meaningful
                experiences that resonate with users and deliver real value.
              </p>
            </div>
